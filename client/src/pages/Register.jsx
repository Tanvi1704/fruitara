...
function Register() {
  ...
  const handleOnSubmit = async (e) => {
    ...
    await fetch("https://fruitara.vercel.app/api/v1/user/register", {
      method: "POST",
      headers: {
        ...
        >
          ...
          <div className="mb-3">
            ...
            <input
              ...
              name="name"
              className="shadow-sm bg-white appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shdow-outline"
            />
          </div>
          <div className="mb-3">
