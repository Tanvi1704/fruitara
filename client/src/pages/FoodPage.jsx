                    ...
                    <div className="bg-red-200/[.3] border rounded p-8 text-black mb-5">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <span className="flex items-center space-x-4">
                                <div className="bg-red-500 relative cursor-pointer p-4 rounded-full text-white">
                        ...
                        <div className="flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:gap-5 sm:mx-auto sm:justify-center">
                            <button className="bg-white active:scale-90 transition duration-500 transform hover:shadow-xl shadow-md rounded-full px-8 py-2 text-xl font-medoum text-[#f54748]">
                             Favourite
                             </button>
                            <button className="bg-[#f54748] active:scale-90 transition duration-500 transform hover:shadow-xl shadow-md rounded-full px-8 py-2 text-xl font-medoum text-white">
                             Add to Cart
                             </button>
