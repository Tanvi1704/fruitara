    ...
    <div className='pt-14'>
      <div className={cartItems?.length===0 ? 'bg-gray-100 h-96' : 'bg-gray-100'}>
        <div className='container mx-auto py-6'>
            <div className='q-full bg-white px-10 py-5 text-black rounded-md'>
                <div className='flex justify-between border-b pb-8'>
                    <h1 className='font-semibold text-2xl'>My Food Cart
                    </h1>
                    <h2 className='font-semibold text-2xl'>{cartItems?.length || 0}
                    </h2>
                </div>
                ...
                <div className={
                    cartItems?.length === 0 ?"mx-auto hidden items-end justify-center px-6 flex-col" : "mx-auto justify-end px-6 flex-col"
                }>
