  ...
  return (
    <>
      <div className="bg-white/80 shadow-md fixed top-0 left-0 w-full z-40 ease-in duration-300 backdrop-blur-md">
        ...
        {user?.user && !user?.user.isVerified && (
      ...
      <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-red-100 shadow">
        <div className="card-body">
          ...
          <div className="card-actions">
            <Link to='/viewcart'>
          <button className="bg-[#f54748] active:scale-90 transition duration-150transform hover:shadow-xl shadow-md rounded-full px-8 py-2 text-xl font-medium text-white mx-auto text-center mb-3 mt-5">
            View Cart
          </button>
          </Link>
          </div>
              ...
              {user ? (
                <div className="dropdown dropdown-end">
                  ...
                  >
                    <li>
                      <Link to="/" className="justify-between">{user?.user?.name} - {user?.user?.role}</Link>
                    </li>
                    <li>
            ...
            <div
              className={`lg:hidden absolute w-1/2 sm:w-2/5 h-screen px-4 py-2 text-xl font-medium ease-in shadow-sm backdrop-blur-md bg-white/80 top-8 duration-500 ${
